...
function Sidebar({
  ...
  if (isMobile) {
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile}>
        <SheetContent side={side} className="w-72 p-0" showClose={false}>
  ...
  return (
    <div
      ...
      className={cn(
        'sticky top-0 flex h-svh shrink-0 flex-col overflow-hidden border-main bg-secondary-700 text-white transition-[width] duration-200',
